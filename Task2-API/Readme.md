...
- ⬅️ **Previous Poem:** Navigate to previously viewed poems
- ➡️ **Next Poem:** View next poem or fetch a new one
...
```
┌─────────────────────────────────────────────┐
│  Welcome back [username]  [Home] [Logout]   │
└─────────────────────────────────────────────┘
...
```bash
mkdir Database
# Create output.json and users.json files
```
